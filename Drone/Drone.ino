...
int wave[2] = {SINE_WAVE, TRIANGLE_WAVE}; // Base waveform not using the square waves  SQUARE_WAVE, HALF_SQUARE_WAVE
...
int hmon[7] = {2, 3, 4, 5, 6, 7, 8}; // harmonic content hz multiplier on gen2 ad9833
...
void setup() {
  ...
  gen.ApplySignal(SINE_WAVE, REG0, 262, 0); 
  gen2.ApplySignal(TRIANGLE_WAVE, REG0, 2620, 0); 
